...
// Uses city hash to produce 64 bit number.
// Never outputs 0 and 1.
...
uint64_t FingerprintXX64(const char* str, uint32_t len);
uint32_t FingerprintXX32(const char* str, uint32_t len);
